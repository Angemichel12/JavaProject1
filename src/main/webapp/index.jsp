        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-lg-auto">
                    ...
                    <li class="nav-item">
                        <a href="aadminlogin.jsp" class="nav-link smoothScroll">Admin</a>
                    </li>
                     <li class="nav-item">
                        <a href="#login" class="nav-link smoothScroll">Log in</a>
                    </li>
                </ul>
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="ml-auto col-lg-5 col-md-6 col-12">
                        ...
                        <form action="Login" method="post" class="contact-form webform" data-aos="fade-up" data-aos-delay="400" role="form">
      ...
      <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="membership-form webform" role="form" action="save(u)" method="post">
                <input type="text" class="form-control" name="fullname" placeholder="Ex: Michel Nasri">

                <input type="text" class="form-control" name="username" placeholder="ex: ange@gmail.com">

                <input type="date" class="form-control" name="age" required>
                    <input type="text" class="form-control" name="country" placeholder="Ex: Rwanda">
                        <input type="text" class="form-control" name="password" placeholder="Ex: user123">
